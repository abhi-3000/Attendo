...
import FacultyQRGenerator from "../../components/FacultyQRGenerator";
    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-20">
      ...
      {attendanceMode === "manual" ? (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                {students?.length === 0 ? (
                  <tr>
                    <td colSpan="4" className="p-8 text-center text-slate-500">
                      No students found for this branch or semester.
                    </td>
                  </tr>
                ) : (
                    ...
                    return (
                      <motion.tr
                        ...
                        className={`transition-colors ${
                          !isPresent ? "bg-red-50" : "hover:bg-slate-50"
                        }`}
                      >
          ...
          <div className="border-t border-slate-200 p-4 flex justify-end gap-4 bg-slate-50">
            <button
              onClick={handleExport}
              className="flex items-center gap-2 px-6 py-3 bg-white border border-slate-300 text-slate-700 rounded-lg hover:bg-slate-100 font-medium transition-colors"
            >
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="flex items-center gap-2 px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-bold shadow-md transition-all disabled:opacity-70"
            >
        ...
        <FacultyQRGenerator courseId={courseId} />
      )}
    </div>
  );
};
